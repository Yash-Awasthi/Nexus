...
import { SQSClient, CreateQueueCommand, SendMessageCommand, DeleteQueueCommand } from "@aws-sdk/client-sqs";
...
function makeTlsClient<T>(ClientClass: new (config: typeof TLS_CLIENT_CONFIG) => T): T {
