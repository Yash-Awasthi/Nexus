...
export function classifyPrompt(
  ...
  const dimensions: DimensionScore[] = [
    ...
    keywordDim(
      "reasoningMarkers",
      countHits(userText, k.reasoning),
      "reasoning",
      { low: 1, high: 2 },
    ...
    keywordDim(
      "technicalTerms",
      countHits(combined, k.technical),
      "technical",
      { low: 2, high: 4 },
      { none: 0, low: 0.5, high: 1.0 },
    ),
    ...
    keywordDim(
      "imperativeVerbs",
      countHits(combined, k.imperative),
      "imperative",
      { low: 1, high: 2 },
    ...
    keywordDim(
      "constraintCount",
      countHits(combined, k.constraints),
      "constraints",
      { low: 1, high: 3 },
    ...
    keywordDim(
      "outputFormat",
      countHits(combined, k.outputFormat),
      "format",
      { low: 1, high: 2 },
    ...
    keywordDim(
      "referenceComplexity",
      countHits(combined, k.references),
      "references",
      { low: 1, high: 2 },
      { none: 0, low: 0.3, high: 0.5 },
    ),
    ...
    keywordDim(
      "domainSpecificity",
      countHits(combined, k.domainSpecific),
      "domain-specific",
      { low: 1, high: 2 },
