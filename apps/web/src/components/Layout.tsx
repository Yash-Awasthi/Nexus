...
const styles = {
  ...
  sidebar: {
    ...
    padding: "24px 0", display: "flex", flexDirection: "column" as const,
  },
  logo: { padding: "0 20px 24px", fontSize: 20, fontWeight: 700, letterSpacing: "-0.5px", color: "#7c3aed" },
  nav: { flex: 1 },
  link: (active: boolean): React.CSSProperties => ({
    display: "flex", alignItems: "center", gap: 10, padding: "9px 20px",
    fontSize: 14, color: active ? "#c4b5fd" : "#94a3b8",
