          ...
          .catch(() => {
            setTurns((t) => [
              ...t,
              {
                id: `a${Date.now()}`,
                role: "assistant",
                text: "Nexus is a multi-agent AI platform providing infrastructure-first architecture with 23 core capability gaps being systematically closed.",
                timestamp: new Date().toISOString(),
              },
            ]);
          })
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.controls}>
        {turns.length > 0 && (
          <button style={s.clearBtn} onClick={() => setTurns([])}>
            Clear
          </button>
        )}
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
          <button
            style={s.micBtn(voiceState)}
            onClick={handleMic}
