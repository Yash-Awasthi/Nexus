...
export default function Settings() {
  ...
  useEffect(() => {
    api
      .get<{ routes: AliasEntry[] }>("/admin/routes")
    ...
    api
      .get<{ flags: FeatureFlag[] }>("/feature-flags")
    ...
    <div>
      ...
      <div style={s.section}>
          ...
          <div key={key} style={s.row}>
            ...
            <input
              ...
              onChange={(e) =>
                setSys((s) => ({
                  ...s,
                  [key]: key === "maxConcurrency" ? Number(e.target.value) : e.target.value,
                }))
              }
            />
          </div>
        ...
        <div style={s.row}>
          ...
          <button
            style={s.toggle(sys.enableTelemetry)}
            onClick={() => setSys((s) => ({ ...s, enableTelemetry: !s.enableTelemetry }))}
          />
        </div>
