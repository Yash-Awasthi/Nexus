    ...
    <div style={{ maxWidth: 720 }}>
      ...
      {result && (
        ...
        >
          ...
          <h3
            style={{ fontSize: 13, color: "#64748b", textTransform: "uppercase", marginBottom: 12 }}
          >
            Archetype Votes
          </h3>
          {result.votes.map((v, i) => {
            ...
            return (
              <div
                key={i}
                style={{ borderTop: "1px solid #1e2535", paddingTop: 12, marginTop: 12 }}
              >
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                  <span style={{ color: "#c4b5fd", fontWeight: 600 }}>{v.model}</span>
                  <span style={{ color: vc, fontWeight: 700, textTransform: "uppercase" }}>
                    {v.vote}
                  </span>
                </div>
                <p style={{ fontSize: 12, color: "#64748b", lineClamp: 3 }}>
