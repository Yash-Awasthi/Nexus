...
const GRAPH: SessionGraph = {
  ...
  nodes: [
    { id: "n:phase:0:started", kind: "phase", label: "started", ts: "2026-09-07T00:00:00Z" },
    {
      ...
      kind: "tool",
      label: "write_file",
      detail: '{"path":"memory-proof.txt"}',
      ts: "2026-09-07T00:00:01Z",
    },
    {
      id: "n:tool:1:out",
      kind: "error",
      label: "write_file result",
      detail: "error: EACCES permission denied",
      ts: "2026-09-07T00:00:01Z",
    },
    {
      id: "n:tool:2",
...
const SKILL_GRAPH: SessionGraph = {
  ...
  nodes: [
    ...
    // each attempt = started node + terminal node (completed/failed).
    {
      ...
      kind: "skill",
      label: "report-writer",
      detail: "[skill-1] python · 30000ms budget",
      status: "started",
      ts: "2026-09-07T00:00:02Z",
    },
    {
      id: "n:skill:1",
      kind: "skill",
      label: "report-writer result",
      detail: "[skill-1] completed in 1200ms (exit 0)",
      status: "completed",
      ts: "2026-09-07T00:00:02Z",
    },
    {
      ...
      kind: "skill",
      label: "scraper",
      detail: "[skill-2] bash · 30000ms budget",
      status: "started",
      ts: "2026-09-07T00:00:03Z",
    },
    {
      id: "n:skill:2",
      kind: "skill",
      label: "scraper result",
      detail: "[skill-2] failed (exit 2) — Traceback: boom",
      status: "failed",
      ts: "2026-09-07T00:00:03Z",
    },
  ],
        ...
        ...Array.from({ length: 5 }, (_, i) => [
          {
            ...
            kind: "skill" as const,
            label: `skill-${i + 1}`,
            detail: `[s${i + 1}] started`,
            status: "started" as const,
            ts: "2026-09-07T00:00:10Z",
          },
          {
            id: `n:s${i + 1}`,
            kind: "skill" as const,
            label: `skill-${i + 1} result`,
            detail: `[s${i + 1}] completed in ${i + 1}ms (exit 0)`,
