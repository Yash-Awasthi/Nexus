 ...
 *
 * POST /redteam/transform  — apply obfuscation to text
 * GET  /redteam/techniques — list available techniques + descriptions
 * GET  /redteam/triggers   — list default trigger word list
 *
 * @nexus/redteam detects trigger words likely to cause model refusals and
...
export async function redteamRoutes(app: FastifyInstance): Promise<void> {
  /**
   * POST /redteam/transform
   *
   * Body:
