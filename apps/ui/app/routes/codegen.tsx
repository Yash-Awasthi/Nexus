...
import {
  ...
  clearSession,
  type CodegenSession,
} from "~/components/ContinueEditingBar";
...
export default function CodeGenPage() {
  ...
  const [stack, setStack] = useState<string>(() => {
    try {
      return localStorage.getItem("codegen_stack") ?? "html";
    } catch {
      return "html";
    }
  });
  ...
  useEffect(() => {
    try {
      localStorage.setItem("codegen_stack", stack);
    } catch {}
  }, [stack]);
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.25em", color: "#00ff88" }}>
          CODEGEN
        </span>
            ...
            {files.length > 0 && (
              <div style={{ borderTop: "1px solid #1a1a1a", paddingTop: 10 }}>
                ...
                <textarea
                  ...
                  onKeyDown={(e) => {
                    if (e.key === "Enter" && (e.ctrlKey || e.metaKey)) iterate();
                  }}
                ...
                <button
                  ...
                  style={{
                    ...
                    fontFamily: MONO,
                    letterSpacing: "0.1em",
                    cursor: iterPrompt.trim() && !isIterating ? "pointer" : "not-allowed",
                    background: "none",
          ...
          {view === "editor" && (
            <div style={{ flex: 1, padding: 10, overflow: "hidden" }}>
              <CodeEditor
                ...
                onChange={(val) =>
                  setFiles((prev) =>
                    prev.map((f, i) => (i === activeFile ? { ...f, content: val } : f)),
                  )
                }
