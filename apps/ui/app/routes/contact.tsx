...
import { FadeIn, TiltCard, MagneticButton, DottedGrid } from "~/components/animations";
      ...
      <section className="relative border-b border-border/40 bg-gradient-to-b from-background to-muted/20 px-6 py-24 text-center overflow-hidden">
        ...
        <FadeIn>
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Have a question, want to partner, or need enterprise support? We'd love to hear from
            you.
          </p>
        </FadeIn>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <FadeIn delay={0.3} className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="font-display text-base">Community</CardTitle>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-display text-base">Enterprise</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  For enterprise inquiries including on-premise deployment, SSO integration, custom
                  SLAs, and dedicated support, contact our sales team directly.
                </p>
