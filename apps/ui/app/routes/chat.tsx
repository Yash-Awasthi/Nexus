  ...
  useEffect(() => {
    ...
    const offVerdict = onVerdict((data: MoleculeVerdict) => {
      ...
      if (verdictRef.current)
        requestAnimationFrame(() => {
          verdictRef.current!.scrollTop = verdictRef.current!.scrollHeight;
        });
    });
  ...
  return (
    ...
    >
      ...
      >
              ...
              {threads.map((t) => (
                <div
                  ...
                  style={{
                    ...
                    padding: "7px 12px",
                    cursor: "pointer",
                    background: t.id === threadId ? "#162a1625" : "transparent",
                    borderBottom: `1px solid ${C.border}18`,
                  }}
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLDivElement).style.background = "#162a1615";
                  }}
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLDivElement).style.background =
                      t.id === threadId ? "#162a1625" : "transparent";
                  }}
                >
                  <span
                    style={{
                      fontSize: "11px",
                      color: t.id === threadId ? C.green : C.greenDim,
                      overflow: "hidden",
        ...
        {totalRounds > 0 && (
          <span
            style={{ fontSize: "9px", color: C.textDim, letterSpacing: "0.15em", flexShrink: 0 }}
          >
        ...
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "6px" }}>
          ...
          {activeSTM.length > 0 && (
            <a
              ...
              style={{
                background: "transparent",
                border: `1px solid hsl(245 80% 65%/0.5)`,
                borderRadius: "3px",
                padding: "3px 9px",
                fontFamily: MONO,
                fontSize: "10px",
          ...
          <button
            ...
            style={{
              background: "transparent",
              border: `1px solid ${glassOn ? C.green : C.border}`,
              borderRadius: "3px",
              padding: "3px 9px",
              fontFamily: MONO,
              fontSize: "10px",
              color: glassOn ? C.green : C.greenDim,
              cursor: "pointer",
              letterSpacing: "0.08em",
            }}
          >
            ...
            return (
              <div
                ...
                style={{
                  ...
                  display: "flex",
                  flexDirection: "column",
                  borderRight: idx < activeMembers.length - 1 ? `1px solid ${C.border}` : "none",
                  overflow: "hidden",
                  minWidth: 0,
              ...
              >
                ...
                <div
                  style={{
                    ...
                    color: isMuted ? C.textDim : C.green,
                ...
                >
                  <span
                    style={{
                      ...
                      height: "6px",
                      borderRadius: "50%",
                      background: isMuted ? C.textDim : C.green,
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: "none",
                        cursor: "pointer",
                        color: isMuted ? C.amber : C.textDim,
                        padding: "1px",
                        display: "flex",
                        alignItems: "center",
                      }}
                  ...
                  {groups.map((g, gi) => {
                    ...
                    return (
                      <div key={g.id} style={{ marginBottom: "22px" }}>
                        ...
                        >
                          <span
                            style={{ fontSize: "9px", color: C.textDim, letterSpacing: "0.15em" }}
                          >
                            RND {g.round}
                          </span>
                          {text && (
                            <button
                              ...
                              style={{
                                ...
                                border: "none",
                                cursor: "pointer",
                                color: copied === copyKey ? C.green : C.textDim,
                                padding: "1px",
                                display: "flex",
                                alignItems: "center",
                ...
                <span style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      cursor: "pointer",
                      color: copied === key ? C.green : C.textDim,
                      padding: "1px",
                      display: "flex",
                      alignItems: "center",
                    }}
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      cursor: "pointer",
                      color: speaking ? C.cyan : C.textDim,
                      padding: "1px",
                      display: "flex",
                      alignItems: "center",
                    }}
      ...
      >
        ...
        {streaming ? (
          ...
          <button
            ...
            disabled={!input.trim()}
            style={{
              background: !input.trim() ? "transparent" : C.green,
              color: !input.trim() ? C.greenDim : "#050505",
              border: `1px solid ${!input.trim() ? C.border : C.green}`,
              borderRadius: "3px",
              padding: "6px 16px",
              fontFamily: MONO,
              fontSize: "11px",
          ...
          >
            ...
            {[
              ...
              <div key={k} style={{ display: "flex", gap: "16px", marginBottom: "8px" }}>
                <span style={{ fontSize: "10px", color: C.green, width: "90px", flexShrink: 0 }}>
                  {k}
                </span>
...
function SettingsPanel({
  ...
  const toggle = (id: string) =>
    setLocal((prev) => prev.map((m) => (m.id === id ? { ...m, enabled: !m.enabled } : m)));
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ fontSize: "11px", letterSpacing: "0.22em", color: C.green }}>
            COUNCIL CONFIG
          </span>
          <button
            onClick={onClose}
            ...
            >
              <span
                style={{
                  ...
                  height: "7px",
                  borderRadius: "50%",
                  background: m.enabled ? C.green : C.textDim,
                  flexShrink: 0,
                }}
              />
              <span style={{ flex: 1, fontSize: "11px", color: m.enabled ? C.text : C.textDim }}>
                {m.label}
              </span>
              <span style={{ fontSize: "9px", color: C.textDim }}>
                {m.mode === "api" ? m.model : "browser"}
              ...
              <button
                ...
                style={{
                  background: "transparent",
                  border: `1px solid ${m.enabled ? C.green : C.textDim}`,
                  borderRadius: "2px",
                  padding: "2px 8px",
                  fontFamily: MONO,
                  fontSize: "9px",
                  color: m.enabled ? C.green : C.textDim,
                  cursor: "pointer",
                  letterSpacing: "0.1em",
                }}
              >
            ...
            {expanded === m.id && (
              ...
              >
                ...
                <SRow label="MODE">
                  <select
                    value={m.mode}
                    onChange={(e) => update(m.id, { mode: e.target.value as "browser" | "api" })}
                    style={iStyle}
                  >
...
function ContextPickerOverlay({
  ...
  useEffect(() => {
    ...
    if (!mention.isOpen || !mention.mentionType) {
      setResults([]);
      return;
    }
  ...
  return (
    ...
    >
      ...
      >
        <span>
          {typeLabel} {mention.query ? `· "${mention.query}"` : ""}
        </span>
      ...
      <div style={{ overflowY: "auto", flex: 1 }}>
        {!mention.mentionType ? (
          <div style={{ padding: "10px 12px" }}>
            {[
              ["@file:", "search project files"],
              ["@symbol:", "search exports/functions"],
              ["@web:", "search the web"],
            ].map(([cmd, hint]) => (
          ...
          results.map((r, i) => (
            <div
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLDivElement).style.background = "#1a2a1a";
              }}
              onMouseLeave={(e) => {
      ...
      <div
        style={{ padding: "4px 10px", borderTop: `1px solid #111`, fontSize: 9, color: textDim }}
      >
