          ...
          <CardContent className="pt-4 space-y-1">
            ...
            {d.modelHint && (
              <p className="text-xs text-muted-foreground">
                Model hint: <code className="bg-muted px-1 rounded">{d.modelHint}</code>
              </p>
            )}
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-4 space-y-3">
            {result.primary && (
              <div className="flex items-center gap-2">
                ...
                <Badge className="bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-900/40 dark:text-fuchsia-400">
                  {result.primary}
                </Badge>
              </div>
            )}
      ...
      <Card>
        <CardContent className="pt-4 space-y-3">
          <p className="text-sm text-muted-foreground">
            Apply a domain specialisation profile to an active session.
          </p>
          <Input
          ...
          />
          <Input
            placeholder="Domain ID (e.g. legal, medical, coding)"
            value={domain}
        ...
        <Card className="border-green-200 dark:border-green-800">
          <CardContent className="pt-4 flex items-start gap-3">
            ...
            <div>
              ...
              {result.model && (
                <p className="text-xs text-muted-foreground">
                  Routed to: <code className="bg-muted px-1 rounded">{result.model}</code>
                </p>
              )}
            </div>
          </CardContent>
