...
const MOCK_ENTRIES: AuditEntry[] = [
  ...
  {
    id: "2",
    timestamp: "2026-04-22 14:28:15",
    user: "bob@example.com",
    action: "config.update",
    resource: "system/rate_limit_max",
    ip: "10.0.0.15",
  },
  {
    id: "3",
    timestamp: "2026-04-22 14:15:33",
    user: "alice@example.com",
    action: "chat.create",
    resource: "chat/session-847",
    ip: "192.168.1.42",
  },
  {
    id: "4",
    timestamp: "2026-04-22 13:55:10",
    user: "carol@example.com",
    action: "kb.upload",
    resource: "kb/eng-docs/file-291",
    ip: "172.16.0.8",
  },
  {
    id: "5",
    timestamp: "2026-04-22 13:42:00",
    user: "david@example.com",
    action: "workflow.run",
    resource: "workflow/code-review",
    ip: "10.0.0.22",
  },
  {
    id: "6",
    timestamp: "2026-04-22 13:30:45",
    user: "elena@example.com",
    action: "user.role_change",
    resource: "user/frank-weber",
    ip: "192.168.1.100",
  },
  {
    id: "7",
    timestamp: "2026-04-22 12:58:22",
    user: "bob@example.com",
    action: "memory.compact",
    resource: "memory/local",
    ip: "10.0.0.15",
  },
  {
    id: "8",
    timestamp: "2026-04-22 12:45:11",
    user: "grace@example.com",
    action: "prompt.update",
    resource: "prompt/code-review-v7",
    ip: "172.16.0.3",
  },
  {
    id: "9",
    ...
    user: "alice@example.com",
    action: "chat.delete",
    resource: "chat/session-812",
    ip: "192.168.1.42",
  },
  {
    id: "10",
    timestamp: "2026-04-22 11:15:33",
  ...
  {
    id: "11",
    timestamp: "2026-04-22 10:48:19",
    user: "david@example.com",
    action: "workflow.create",
    resource: "workflow/security-audit",
    ip: "10.0.0.22",
  },
  {
    id: "12",
    timestamp: "2026-04-22 09:22:07",
    user: "elena@example.com",
    action: "config.update",
    resource: "system/maintenance_mode",
    ip: "192.168.1.100",
  },
];
                      ...
                      <tr key={entry.id} className="border-b border-border/50 hover:bg-muted/30">
                        ...
                        <td className="px-4 py-3">
                          <Badge
                            variant="outline"
                            className={
                              "text-[10px] font-mono " + (ACTION_COLORS[entry.action] ?? "")
                            }
                          >
                            {entry.action}
                          </Badge>
