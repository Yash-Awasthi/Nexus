...
export default [
  ...
  route("session-graph", "routes/session-graph.tsx"),
  ...
  route("gauntlet", "routes/gauntlet.tsx"),
  route("redteam", "routes/redteam.tsx"),
  route("drift", "routes/drift.tsx"),
  ...
  route("conductor", "routes/conductor.tsx"),
